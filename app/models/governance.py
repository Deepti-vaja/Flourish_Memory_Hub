...
class GovernanceDecision(Base):
    ...
    item_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True), ForeignKey("knowledge_items.item_id", ondelete="RESTRICT"), nullable=False, index=True
    )
    ...
    decision_type: Mapped[str] = mapped_column(String(50), nullable=False)  # 'APPROVED' or 'REJECTED'
    ...
    # Relationships
    item: Mapped["KnowledgeItem"] = relationship("KnowledgeItem", back_populates="governance_decisions")
