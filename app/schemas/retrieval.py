...
class SearchRequest(BaseDTOSchema):
    ...
    alpha: float = Field(default=0.5, ge=0.0, le=1.0, description="Hybrid RRF balance weighting (`0.5 default`)")
...
class GetItemResponse(BaseDTOSchema):
    ...
    version: int = Field(default=1, description="Item version increment")
    source_uri: Optional[str] = Field(default=None, description="Lineage source URI")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Item metadata dict")
