...
class IngestItemRequest(BaseDTOSchema):
    ...
    namespace: str = Field(..., min_length=1, max_length=255, description="Domain namespace (`eng.core`, `hr.secret`)")
    sensitivity_level: int = Field(default=1, ge=1, le=4, description="Vertical clearance ceiling (`1 to 4`)")
    source_uri: Optional[str] = Field(default=None, max_length=1024, description="Lineage source URI")
    metadata: Optional[Dict[str, Any]] = Field(default=None, description="Optional custom metadata dict")
