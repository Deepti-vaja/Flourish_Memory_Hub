...
def register_exception_handlers(app: FastAPI) -> None:
    ...
    async def invalid_caller_context_handler(
        request: Request, exc: InvalidCallerContextError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=401,
            content={
    ...
    async def namespace_not_found_handler(
        request: Request, exc: NamespaceNotFoundError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=404,
            content={
    ...
    async def search_clearance_handler(
        request: Request, exc: SearchClearanceViolationError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=403,
            content={
    ...
    async def steward_auth_handler(
        request: Request, exc: StewardAuthorizationError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=403,
            content={
    ...
    async def four_eyes_handler(
        request: Request, exc: FourEyesPrincipleViolationError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=403,
            content={
    ...
    async def namespace_access_handler(
        request: Request, exc: NamespaceAccessDeniedError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=403,
            content={
    ...
    async def sensitivity_violation_handler(
        request: Request, exc: SensitivityViolationError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=403,
            content={
    ...
    async def prompt_injection_handler(
        request: Request, exc: PromptInjectionSecurityError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=422,
            content={
    ...
    async def embedding_dimension_handler(
        request: Request, exc: EmbeddingDimensionError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=422,
            content={
    ...
    async def token_budget_handler(
        request: Request, exc: TokenBudgetExhaustionError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=400,
            content={
    ...
    async def ingestion_payload_handler(
        request: Request, exc: IngestionPayloadError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=400,
            content={
    ...
    async def invalid_dimension_handler(
        request: Request, exc: InvalidVectorDimensionError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=400,
            content={
    ...
    async def document_not_pending_handler(
        request: Request, exc: DocumentNotPendingError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=409,
            content={
    ...
    async def base_governance_handler(
        request: Request, exc: FlourishGovernanceError
    ) -> JSONResponse:
        return JSONResponse(
            status_code=500,
            content={
